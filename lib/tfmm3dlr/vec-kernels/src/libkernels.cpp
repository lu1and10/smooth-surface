...
void erf_svml_cpp_(const double* x, const int64_t* n, double* erfx){
  erf_svml_vec_cpp<double, VECDIM>(x, n, erfx);
}

void erf0_cpp_(const double* x, const int64_t* n, double* erfx){
  erf0_vec_cpp<double, VECDIM>(x, n, erfx);
}

void erf1_cpp_(const double* x, const int64_t* n, double* erfx){
  erf1_vec_cpp<double, VECDIM>(x, n, erfx);
}

void erf2_cpp_(const double* x, const int64_t* n, double* erfx){
  erf2_vec_cpp<double, VECDIM>(x, n, erfx);
}

void t3ddirectdg_cpp_(const int64_t* nd, const double* sources, const double* dipvec, const int64_t* ns, const double* ztarg, const int64_t* nt, double* pot, double* grad, const double* thresh, const double* qwt, const double* sigma, const double*  sigma_grad){
    t3ddirectdg_vec_cpp<double, VECDIM>(nd, sources, dipvec, ns, ztarg, nt, pot, grad, thresh, qwt, sigma, sigma_grad);
}
#ifdef __cplusplus
}
#endif
